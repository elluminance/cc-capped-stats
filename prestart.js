...
sc.HpHudGui.inject({
    init(){
        ...
        this.hpNumber = new sc.NumberGui(9, {
            signed: true,
            transitionTime: 0.5
        });
        this.hpNumber.setPos(39, 1);
...
sc.EquipStatusContainer.inject({
    init(){
        ...
        this.baseParams.hp = this._createStatusDisplay(0, b, "maxhp", 0, 0, false, 9, c.hp, void 0, a);
        b = b + 14;
        this.baseParams.atk = this._createStatusDisplay(0, b, "atk", 0, 1, false, 9, c.attack, void 0, a);
        b = b + 14;
        this.baseParams.def = this._createStatusDisplay(0, b, "def", 0, 2, false, 9, c.defense, void 0, a);
        b = b + 14;
        this.baseParams.foc = this._createStatusDisplay(0, b, "foc", 0, 3, false, 9, c.focus, void 0, a);
        b = b + 16;
        this.baseParams.fire = this._createStatusDisplay(0, b, "res", 1, 4, true, 9, c.elemFactor[0], void 0, a);
        b = b + 14;
        this.baseParams.cold = this._createStatusDisplay(0, b, "res", 2, 5, true, 9, c.elemFactor[1], void 0, a);
        b = b + 14;
        this.baseParams.shock = this._createStatusDisplay(0, b, "res", 3, 6, true, 9, c.elemFactor[2], void 0, a);
        this.baseParams.wave = this._createStatusDisplay(0, b + 14, "res", 4, 7, true, 9, c.elemFactor[3], void 0, a);
...
sc.StatusViewMainParameters.inject({
    init(){
        this.parent();
        var a = 97;
        this.baseParams.hp = this.createStatusDisplay(0, a, "maxhp", 0, 0, false, 9);
        a = a + 14;
        this.baseParams.atk = this.createStatusDisplay(0, a, "atk", 0, 1, false, 9);
        a = a + 14;
...
sc.StatusParamBar.inject({
    init(a, b, c, e, f, g, h, i, j){
        ...
        this.base.setPos(83 + 16 - (this.usePercent ? 8 : j ? 0 : -8), 3);
        ...
        this.equip.setPos(127 + 16 - (this.usePercent ? 8 : j ? 0 : -8), 3);
        ...
        this.equipAdd.setPos(127 + 16 - (this.usePercent ? 8 : j ? 0 : -8), 13);
        ...
        this.skills.setPos(171 + 16 - (this.usePercent ? 8 : j ? 0 : -8), 3);
        ...
        this.skillAdd.setPos(171 + 16 - (this.usePercent ? 8 : j ? 0 : -8), 13);
...
sc.TradeToggleStats.inject({
    _createContent(){
        ...
        this.baseParams.hp = this._createStatusDisplay(b, a, "maxhp", 0, 0, false, 9, d.hp);
        a = a + 14;
        this.baseParams.atk = this._createStatusDisplay(b, a, "atk", 0, 1, false, 9, d.attack);
        a = a + 14;
        this.baseParams.def = this._createStatusDisplay(b, a, "def", 0, 2, false, 9, d.defense);
        a = a + 14;
        this.baseParams.foc = this._createStatusDisplay(b, a, "foc", 0, 3, false, 9, d.focus);
        a = a + 16;
        this.baseParams.fire = this._createStatusDisplay(b, a, "res", 1, 4, true, 9, d.elemFactor[0], 0);
        a = a + 14;
        this.baseParams.cold = this._createStatusDisplay(b, a, "res", 2, 5, true, 9, d.elemFactor[1], 1);
        a = a + 14;
        this.baseParams.shock = this._createStatusDisplay(b, a, "res", 3, 6, true, 9, d.elemFactor[2], 2);
        a = a + 14;
        this.baseParams.wave = this._createStatusDisplay(b, a, "res", 4, 7, true, 9, d.elemFactor[3], 3);
        a = a + 14;
